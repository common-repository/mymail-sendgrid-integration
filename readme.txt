...
> This Plugin requires [MyMail Newsletter Plugin for WordPress](https://evp.to/mymail?utm_campaign=wporg&utm_source=SendGrid+integration+for+MyMail)

Uses SendGrid to deliver emails for the [MyMail Newsletter Plugin for WordPress](https://evp.to/mymail?utm_campaign=wporg&utm_source=SendGrid+integration+for+MyMail).
